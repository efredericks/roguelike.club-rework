...
<xsl:template match="/atom:feed">
	...
	<link rel="canonical" href="http://localhost:4000/roguelike.club-rework/assets/xslt/atom.xslt">


	<!-- Facebook Open Graph -->
	<meta property="og:title" content="Atom Feed (Styled)">
	<meta property="og:description" content="| ! % . . @ . @ . . @ . . . @ @ . \ \ \ \ \ . |">
	<meta property="og:url" content="http://localhost:4000/roguelike.club-rework/assets/xslt/atom.xslt">
	...
	<link rel="icon" sizes="192x192" href="http://localhost:4000/roguelike.club-rework/assets/img/touch-icon-192x192.png">

	<link rel="apple-touch-icon-precomposed" sizes="180x180" href="http://localhost:4000/roguelike.club-rework/assets/img/apple-touch-icon-180x180-precomposed.png">

	<link rel="apple-touch-icon-precomposed" sizes="152x152" href="http://localhost:4000/roguelike.club-rework/assets/img/apple-touch-icon-152x152-precomposed.png">

	<link rel="apple-touch-icon-precomposed" sizes="144x144" href="http://localhost:4000/roguelike.club-rework/assets/img/apple-touch-icon-144x144-precomposed.png">

	<link rel="apple-touch-icon-precomposed" sizes="120x120" href="http://localhost:4000/roguelike.club-rework/assets/img/apple-touch-icon-120x120-precomposed.png">

	<link rel="apple-touch-icon-precomposed" sizes="114x114" href="http://localhost:4000/roguelike.club-rework/assets/img/apple-touch-icon-114x114-precomposed.png">

	
	<link rel="apple-touch-icon-precomposed" sizes="76x76" href="http://localhost:4000/roguelike.club-rework/assets/img/apple-touch-icon-76x76-precomposed.png">

	<link rel="apple-touch-icon-precomposed" sizes="72x72" href="http://localhost:4000/roguelike.club-rework/assets/img/apple-touch-icon-72x72-precomposed.png">

	<link rel="apple-touch-icon-precomposed" href="http://localhost:4000/roguelike.club-rework/assets/img/apple-touch-icon-precomposed.png">	

	<meta name="msapplication-TileImage" content="http://localhost:4000/roguelike.club-rework/assets/img/msapplication_tileimage.png">
    ...
    <section class="top-bar-section">
      ...
      <ul class="left">
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000/roguelike.club-rework/headers/">Header Styles</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://localhost:4000/roguelike.club-rework/design/header-full-width-image/">Header with Full-Width-Image</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/roguelike.club-rework/design/header-image-pattern/">Header with Image and Pattern</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/roguelike.club-rework/design/header-image-color/">Header with image and color</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/roguelike.club-rework/design/header-logo-only/">Header Only With Logo</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/roguelike.club-rework/design/header-with-text/">Header With Text</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/roguelike.club-rework/design/no-header/">No Header</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/roguelike.club-rework/design/no-header-but-image/">No Header but Image</a></li>
        ...
        <div class="row">
          ...
          <div class="small-6 medium-3 large-3 large-offset-1 columns">
              ...
              <ul class="no-bullet shadow-black">
                  ...
                  <li >
                    <a href="http://localhost:4000/roguelike.club-rework"  title=""></a>
                  </li>
              
                
                  <li >
                    <a href="http://localhost:4000/roguelike.club-rework/contact/"  title="Contact">Contact</a>
                  </li>
              
                
                  <li >
                    <a href="http://localhost:4000/roguelike.club-rework/feed.xml"  title="Subscribe to RSS Feed">RSS</a>
                  </li>
              
                
                  <li >
                    <a href="http://localhost:4000/roguelike.club-rework/atom.xml"  title="Subscribe to Atom Feed">Atom</a>
                  </li>
              
                
                  <li >
                    <a href="http://localhost:4000/roguelike.club-rework/sitemap.xml"  title="Sitemap for Google Webmaster Tools">sitemap.xml</a>
                  </li>
